...
/*   Updated: 2024/04/24 12:38:14 by Achakkaf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/// @brief close windown if you press on the red x
/// @param param is mlx
int		mouse(void *param);

/// @brief set mlx struct to it default values
...
/// @param keycode
/// @param param mlx
///	@return doesn't have any meaning
